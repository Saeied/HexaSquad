...
const LandingHeader = () => {
  ...
  return (
    <div className="relative w-full h-[900px] m-auto bg-[url(../../../public/header-bg.png)] bg-[length:100%_90%] bg-no-repeat dark:invert-[1] dark:text-black flex flex-row flex-nowrap justify-center px-6 pt-6 md:pt-20">
